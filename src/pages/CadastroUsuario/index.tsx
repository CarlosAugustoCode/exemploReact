...
function CadastroUsuario() {
    ...
    //Função verificar o que tem no input de arquivo
    function verificarCampoUpload(event: any){
        setFoto(event.target.files[0]) //Pegar o valor atual no campo Arquivo (no input)        
    }
                    ...
                    <form onSubmit={CadastrarUsuario} className="cad_formulario" method="POST">
                        ...
                        <div className="cad_box_input">
                            ...
                            <input
                                type="file"
                                id="foto"
                                onChange={verificarCampoUpload} // Quando alterar o valor do input, ele chama a função verificarCampoUpload()
                                required
                            />
                        </div>
